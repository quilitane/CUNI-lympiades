...
import TipBar from "../components/TipBar"; // <-- Bandeau d’indices
...
const Container = styled.div`
  ...
  /* Espace pour ne pas passer sous le TipBar fixe (hauteur 40px) */
  padding-top: 48px;
`;
...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      {/* Bandeau d'indices en haut de page */}
      <TipBar />
        ...
        {isPaused ? (
          <div style={{ textAlign: "center", marginTop: "3rem" }}>
            <p style={{ fontSize: "1.5rem", marginBottom: "1rem" }}>
              ⏸️ La partie est en pause
            </p>
            <p style={{ fontSize: "1.1rem" }}>
              Reprise prévue le{" "}
              {new Date(pauseUntil!).toLocaleString("fr-FR", {
                dateStyle: "medium",
                timeStyle: "short",
              })}
            </p>
